...
# product is configured individually rather than via a generic brand-style Col map.

$PKYC_SpreadsheetId = "1OL_Trll9xJjtS4VaknU6zS3GYxcYdq-9dHvRe8a2JrY"
...
$PKYC_Products = @(
    ...
    @{
        ...
        compare = @{ likeMoreCol = 12; likeLessCol = 14; labelA = "Guava Tini De-Tan Body Wash"; labelB = "Exfoliating Caramel Crunch Body Wash"; shortA = "Guava Tini"; shortB = "Caramel Crunch" }
        freeText = @( @{ l = "Why liked it less"; c = 15 }, @{ l = "Improvements wanted"; c = 17 }, @{ l = "Remarks"; c = 24 } )
    },
    @{
        key = "raspberry_wash"; category = "bodywash"; kind = "standalone"; tab = "Brightening Raspberry Rush Body Wash"; label = "Brightening Raspberry Rush Body Wash"
        categorical = @(
            @{ l = "Gender"; c = 10 }, @{ l = "Age Group"; c = 11 }, @{ l = "Skin Type"; c = 12 },
            @{ l = "Experience Rating (1-5)"; c = 15 }, @{ l = "Packaging Rating (1-5)"; c = 19 }, @{ l = "Would Purchase Again"; c = 22 }
        )
    ...
    @{
        ...
        compare = @{ likeMoreCol = 13; likeLessCol = 15; labelA = "Summer Breeze Perfume Body Lotion"; labelB = "Sweet Escape Perfume Body Lotion"; shortA = "Summer Breeze"; shortB = "Sweet Escape" }
        freeText = @( @{ l = "Why liked it less"; c = 16 }, @{ l = "One thing to change"; c = 18 }, @{ l = "Remarks"; c = 27 } )
    },
    @{
        key = "magnesium_lotion"; category = "lotions"; kind = "standalone"; tab = "Magnesium Body Lotion"; label = "Magnesium Body Lotion"
        categorical = @(
    ...
    @{
        ...
        categorical = @( @{ l = "Gender"; c = 17 }, @{ l = "Preferred Format"; c = 11 }, @{ l = "Would Try Chapstick Format"; c = 14 } )
        freeText = @( @{ l = "Dislikes / improvements"; c = 13 }, @{ l = "Other suggestions"; c = 15 } )
    },
    @{
        key = "jelly_glaze"; category = "lipbalms"; kind = "standalone"; tab = "Jelly Glaze Lip Balm"; label = "Jelly Glaze Lip Balm"
        categorical = @(
    ...
    # ---------------- Scrubs ----------------
    @{
        key = "cookie_scrub"; category = "scrubs"; kind = "standalone"; tab = "Cookie Face scrub"; label = "Cookie Face Scrub"
        categorical = @( @{ l = "Would Recommend"; c = 20 } )
        freeText = @( @{ l = "Fragrance / texture / packaging feedback"; c = 9 }, @{ l = "Improvements wanted"; c = 22 }, @{ l = "Remarks"; c = 24 } )
    }
)

$PKYC_CategoryLabels = [ordered]@{
