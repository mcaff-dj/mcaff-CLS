  ...
  return (
    <aside className="sidebar">
      <div className="sidebarLogo">
        <div className="sidebarLogoMark">N</div>
        <div className="sidebarLogoText">
          <div className="sidebarLogoTitle">NDR Calling</div>
    ...
    <div className="modalOverlay" onClick={onClose}>
      <div className="modalCard" onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true" aria-label="Bulk upload">
        ...
        <div className="modalBody">
          ...
          <a href="/api/orders/sample" className="sampleLink" download>
    ...
    try {
      ...
      if (role === 'agent') {
        ...
        const updates = unassigned.map((o, i) => {
          ...
          return fetch('/api/orders/assign', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
        ...
        <header className="topbar">
          <div className="topbarLeft">
            ...
            <div className="breadcrumb">
              <span className="breadcrumbItem">NDR Calling</span>
